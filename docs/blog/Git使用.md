...
```
> 例如：`git remote add origin git@github.com:EchoHeim/actapb.git`   &emsp; #连接到远程仓库
...
``` bash
git clone --depth 1  git@github.com:EchoHeim/actapb.git
```
...
例如：
``` bash
git remote set-url origin https://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@github.com/EchoHeim/actapb.git/
```
